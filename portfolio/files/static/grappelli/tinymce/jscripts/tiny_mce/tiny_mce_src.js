...
tinymce.util.Quirks = function(editor) {
	...
	function fakeImageResize() {
		...
		function showResizeRect(targetElm) {
			...
			// Reset width/height if users selects a new image/table
...
(function(tinymce) {
	...
	tinymce.EnterKey = function(editor) {
		...
		function handleEnterKey(evt) {
			...
			// Trims any linebreaks at the beginning of node users for example when pressing enter in a PRE element
